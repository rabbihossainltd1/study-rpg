          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-2">
              <div className="flex-1 h-1.5 bg-white/5 rounded-full overflow-hidden">
                <motion.div
                  className={`h-full rounded-full ${isCompleted ? "bg-primary/40" : canClaim ? "bg-gold" : "bg-white/20"}`}
                  initial={{ width: 0 }}
  ...
  const AchievementCard = ({ achievement, index }: { index: number; achievement: typeof ACHIEVEMENTS[0] }) => {
    ...
    return (
      <motion.div
        ...
        className={`glass-card p-4 border transition-all ${
          achievement.isUnlocked ? "border-opacity-30" : "border-white/5 opacity-60"
        }`}
  ...
  return (
    <div className="space-y-5">
      ...
      <motion.div
        ...
        className="glass-card p-4 border border-secondary/15 flex items-center gap-4"
      >
        ...
        <div className="flex-1">
          ...
          <div className="h-2 bg-white/5 rounded-full overflow-hidden">
            <motion.div
              ...
              animate={{ width: `${(completedDaily / totalDaily) * 100}%` }}
