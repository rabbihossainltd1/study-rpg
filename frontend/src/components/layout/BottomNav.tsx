...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 lg:hidden border-t border-white/10 bg-black/90 backdrop-blur-xl px-3 pt-2 pb-[max(10px,env(safe-area-inset-bottom))]">
